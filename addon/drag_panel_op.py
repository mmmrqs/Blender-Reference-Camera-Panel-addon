...
class DP_OT_draw_operator(BL_UI_OT_draw_operator):  # in: bl_ui_draw_op.py ##
    ...
    def __init__(self):
        ...
        if self.button5_pressed(self.button5):
            self.button5.state = 3
        btnC += 1
        ...
        if self.button7_pressed(self.button7):
        ...
        if self.buttonA_pressed(self.buttonA):
            self.buttonA.state = 3
        ...
        if self.button8_pressed(self.button8):
            self.button8.state = 3
        newY = btnY + btnH + btnS
        ...
        if self.button9_pressed(self.button9):
            self.button9.state = 3
        btnC = 0
