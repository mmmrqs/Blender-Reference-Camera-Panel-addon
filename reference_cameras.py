...
def RC_MESHES():
    ...
    return (bpy.context.preferences.addons[__package__].preferences.RC_MESHES)
...
def RC_CAMERAS():
    ...
    return (bpy.context.preferences.addons[__package__].preferences.RC_CAMERAS)
...
def RC_TEMP():
    ...
    """     
    return (bpy.context.preferences.addons[__package__].preferences.RC_TEMP)
...
def RC_TARGETS():
    ...
    """     
    return (bpy.context.preferences.addons[__package__].preferences.RC_TARGETS)
...
def RC_SUBP_MODE():
    ...
    """     
    return (bpy.context.preferences.addons[__package__].preferences.RC_SUBP_MODE)
...
def RC_SUBPANELS():
    ...
    return (bpy.context.preferences.addons[__package__].preferences.RC_SUBPANELS)

def RC_TRGMODE():
    """ Target Objects Display mode: {TEXTURED, SOLID, WIRE, BOUNDS} """ 
    return (bpy.context.preferences.addons[__package__].preferences.RC_TRGMODE)

def RC_TRGCOLOR():
    """ Color and alpha for the camera target object """
    return (bpy.context.preferences.addons[__package__].preferences.RC_TRGCOLOR)

def RC_OPACITY():
    """ Opacity level for the camera backgroud image to blend against the viewport background color """
    return (bpy.context.preferences.addons[__package__].preferences.RC_OPACITY)
...
def RC_ACTION_REMO():
    ...
    """
    return (bpy.context.preferences.addons[__package__].preferences.RC_ACTION_REMO)

def RC_ACTION_MAIN():
    """ Camera Action mode. If (ON) camera action will start when mode button pressed; 
        If (OFF) just set the adjustment mode but do not start camera action.
    """
    return (bpy.context.preferences.addons[__package__].preferences.RC_ACTION_MAIN)
