...
class BL_UI_Tooltip(BL_UI_Patch): 
    ...
    def get_tooltip_measurements(self):
        ...
        text_height = blf.dimensions(0, "W")  # This is to keep a regular pattern since letters differ in height
        if text_kerning:
        ...
        if widget.description != "":
            ...
            for line in self.__tooltip_text_lines:
                ...
                total_height += round(text_height[1]+0.499) + line_spacing
                line_count += 1
        ...
        widest_line = widest_line / ui_scale    
        ...
        textpos_y = tooltip_y + self.__text_margin + round(text_height[1]+0.499) - 1
    ...
    def draw_text(self):
        ...
        label = BL_UI_Label(textpos_x, textpos_y, self.width, text_height[1])
        ...
        if len(self.__tooltip_text_lines) > 0:
            ...
            for line in self.__tooltip_text_lines:
                ...
                line_count += 1
                # Need to unapply the over scale to compensate for posterior calculations
                textpos_y += (round(text_height[1]+0.499) + line_spacing) / over_scale
